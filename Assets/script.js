var apiKey = "47da32504536cbb97084a7f1c3c96d44";
...
function currentCondition(city) {
    ...
    $.ajax({
        ...
        $.ajax({
            ...
            // conditional statement  for  assigning color to uvIndex depending on the uvIndex condition of favorable,  moderate, or severe
            if (uvIndex >= 0 && uvIndex <= 2) {
                $("#uvIndexColor").css("background-color", "#008000").css("color", "white");
            } else if (uvIndex >= 3 && uvIndex <= 5) {
                $("#uvIndexColor").css("background-color","#0000FF" );
            } else if (uvIndex >= 6 && uvIndex <= 7) {
                $("#uvIndexColor").css("background-color", "#FFFF00");
            } else if (uvIndex >= 8 && uvIndex <= 10) {
                $("#uvIndexColor").css("background-color", "#FFA500").css("color", "white");
            } else {
...
// Function to display the last earched weather information when weather app is opened.
